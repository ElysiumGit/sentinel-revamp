...
import co.sentinel.sentinellite.ui.fragment.VpnUsageFragment;

public class VpnSelectPagerAdapter extends FragmentPagerAdapter {

    private final int TAB_TITLES[] = new int[]{R.string.view_vpn_list, R.string.settings/*, R.string.view_socks5_list,*/};
    // REVAMP: SOCKS5 tab removed until further notice
    ...
    public View getTabView(int iPosition) {
       ...
       // aTvTabItem.setText(mContext.getString(TAB_TITLES[iPosition]));
        // REVAMP: Tabview will not longer be visible while only OVPN nodes are displayed.
        return aView;
    }
}
