...
import co.sentinel.sentinellite.ui.activity.GenericListActivity;
...
public class VpnUsageFragment extends Fragment {
    ...
    private void initView(View iView) {
        ...
        clLanguage.setOnClickListener(v -> startActivityForResult(new Intent(getContext(), GenericListActivity.class).putExtra(AppConstants.EXTRA_REQ_CODE, AppConstants.REQ_LANGUAGE), AppConstants.REQ_LANGUAGE));
        ...
        clAbout.setOnClickListener(v -> Toast.makeText(getContext(),"This page will be added in the live build",Toast.LENGTH_SHORT).show());
